...
namespace DAL
{
    public class Permiso : Acceso
    {
        ...
        private const string get_ValidaFamilia = "SELECT P.idPermiso, p.Nombre " +
                                                    "FROM Familia_Patente FM " +
                                                    "INNER JOIN Permiso P ON P.idPermiso = FM.idPermisoPadre " +
                                                    "INNER JOIN Permiso P1 ON P1.idPermiso = FM.idPermisoHijo " +
                                                    "WHERE FM.idPermisoHijo = @idFamilia ";
